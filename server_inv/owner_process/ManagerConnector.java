...
public class ManagerConnector {
    ...
    BufferedReader[] dataIn, PrintWriter[] dataOut) throws Exception {
        ...
        for (int i = myId + 1; i < numProc; i++) {
            PortAddr addr;
            do {
                addr = client.searchName(basename + i);
                Thread.sleep(100);
    ...
    public ManagerInvalidationClient getClient()
    {
      return client;
    }
