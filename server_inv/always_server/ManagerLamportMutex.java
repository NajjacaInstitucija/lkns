public class ManagerLamportMutex extends ManagerProcess implements Lock {
    DirectClock v;
    int[] q; // request queue


    public ManagerLamportMutex(ManagerLinker initComm) {
        super(initComm);
    ...
    public synchronized void requestCS() {
        ...
        Util.println(myId + " has requested CS.");
